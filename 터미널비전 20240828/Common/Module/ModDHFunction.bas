...
Public Function WriteResultLog(ByVal strLog As String)
    ...
    strFilename = "D:\LOG\RESULT_" & Format(Now(), "yyyymm") & ".txt"
...
Public Function WriteLog(strLog As String)
    ...
    strPath = "D:\LOG\" & Format(Now(), "yyyy") & "\" & Format(Now(), "mm") & "\" & Format(Now(), "dd")
    Create_DIR strPath
    
    strFilename = strPath & "\" & Format(Now(), "yyyymmddhh") & ".txt"
...
Public Function WriteErrorLog(strLog As String)
    ...
    strFilename = strPath & "\ErrorLog_" & Format(Now(), "yyyymmddhh") & ".txt"
    strFileNumber = FreeFile
